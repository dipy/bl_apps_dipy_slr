...
[![Run on Brainlife.io](https://img.shields.io/badge/Brainlife-bl.app.332-blue.svg)](https://doi.org/10.25663/brainlife.app.332)

# Dipy Streamline Linear Registration

The App uses the Streamline Linear Registration (SLR) method to align your tractography data.
...
### DIPY
- This is a Brainlife wrapper App stemming from the [`dipy_slr`](https://dipy.org/documentation/latest/reference_cmd/dipy_slr/) workflow.
